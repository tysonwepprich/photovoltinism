...
cdl <- 13.9
emerg_dd <- 113
gen_dd <- 332 # egg to pupa needed for overwinter stage
povip_dd <- 410 - 332 # pupal time before adult emergence/oviposition
ovip_dd <- 10 # guessing here, use poisson process
cdl_sd <- .25 # roughly 13.5 to 14.5 spread
emerg_dd_sd <- 6
gen_dd_sd <- 6
povip_dd_sd <- 12
